(function() {
  var $, RSpine, escapeRegExp, hashStrip, namedParam, splatParam,
  ...
  RSpine.Route = (function(_super) {
    var _ref;

    __extends(Route, _super);

    Route.extend(RSpine.Events);
  ...
  RSpine.Route.change = RSpine.Route.proxy(RSpine.Route.change);

  RSpine.Controller.include({
    route: function(path, callback) {
      return RSpine.Route.add(path, this.proxy(callback));
    },
    ...
    navigate: function() {
      return RSpine.Route.navigate.apply(RSpine.Route, arguments);
    }
  });

  if (typeof module !== "undefined" && module !== null) {
    module.exports = RSpine.Route;
  }
