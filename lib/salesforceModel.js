    ...
    extended: function() {
      ...
      this.include({
        sobjectFormat: function(includeId) {
          var key, object, value, _ref, _ref1;
          if (includeId == null) {
            includeId = false;
          }
          object = {};
          ...
          for (key in _ref) {
            ...
            if (this.constructor.avoidInsertList.indexOf(key) === -1) {
              ...
              } else if (this.constructor.standardFields.indexOf(key) === -1 && (this.constructor.standardObject && ((_ref1 = this.constructor.customFields) != null ? _ref1.indexOf(key) : void 0) > 0)) {
