(function() {
  ...
  RSpine.Manager = (function(_super) {
    __extends(Manager, _super);

    Manager.include(RSpine.Events);
  ...
  RSpine.Stack = (function(_super) {
    ...
    Stack.prototype.className = 'rspine stack';

    function Stack() {
      var key, value, _fn, _ref, _ref1,
        _this = this;
      Stack.__super__.constructor.apply(this, arguments);
      this.manager = new RSpine.Manager;
      _ref = this.controllers;
      for (key in _ref) {
        value = _ref[key];
        if (this[key] != null) {
